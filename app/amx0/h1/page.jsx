...
export default function Hpage() {
  ...
  function parseCSVData() {
    Papa.parse(
      ...
      //`${process.env.NEXT_PUBLIC_S3_AMX0_ADDRESS}/R15/S3_AMXZero_R15_H1.csv`, //R15_H1
      //`${process.env.NEXT_PUBLIC_S3_AMX0_ADDRESS}/R16/S3_AMXZero_R16_H1.csv`, //R16_H1
      `${process.env.NEXT_PUBLIC_S3_AMX0_ADDRESS}/R17/S3_AMXZero_R17_H1.csv`, //R17_H1
      {
        ...commonConfig,
        header: true,
        download: true,
