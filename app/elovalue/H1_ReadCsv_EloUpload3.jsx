...
export default function H1_ReadCsv_EloUpload(props) {
  //S3
  ...
  function parseCSVData() {
    Papa.parse(
      //"https://automanix.s3.ap-northeast-2.amazonaws.com/amx/R1/S3_AMX10_R1_H1.csv", //R1_H1
      //"https://automanix.s3.ap-northeast-2.amazonaws.com/amx/R2/S3_AMX10_R2_H1.csv", //R2_H1
      "https://automanix.s3.ap-northeast-2.amazonaws.com/amx/R3/S3_AMX10_R3_H1.csv", //R2_H1
      {
        ...commonConfig,
        header: true,
        download: true,
  ...
  const s3upload = (data) => {
    ...
    const params = {
      ...
      Body: stringObject,
      Bucket: S3_BUCKET,
      //Key: "amx/R1/R1_H1_ELO.json", // R1_H1
      //Key: "amx/R2/R2_H1_ELO.json", //R2_H1
      Key: "amx/R3/R3_H1_ELO.json", //R3_H1
