...
import ModalChart from "./Modal_Chart";
import ModalHeat1 from "./Modal_Heat1";
import ModalHeat2 from "./Modal_Heat2";
import ModalQualifying from "./Modal_Qualifying";
  ...
  const onDownloadBtn = () => {
    ...
    chartResult.map((row, index) => {
      chartTemp.push({
        ...
        zoom: row.zoomCheck,
        totalPoints: row.rankingPoints + row.fastestPoint + row.zoomCheck,
      });
    });
    ...
    pdfDoc.save(`AMX_Zero_Race${rounds}_Result.pdf`);
  };
    ...
    <>
      ...
      >
        <Stack spacing={1} direction="row">
          <FormControl sx={{ width: "100%" }}>
            <InputLabel id="demo-simple-select-label">AMX Zero</InputLabel>
            <Select
      ...
      >
        ...
        <DialogContent>
          ...
          />
          <ModalHeat2 h2Result={h2Result} />
          <ModalHeat1 h1Result={h1Result} />
          <ModalQualifying qResult={qResult} />
        </DialogContent>
        <DialogActions>
