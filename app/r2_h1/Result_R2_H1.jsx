...
import Elo_R2_H1 from "./Elo_R2_H1";

export default function Result_R2_H1() {
  //담을곳
  var arr = [];
  ...
  function parseCSVData() {
    Papa.parse(
      "https://automanix.s3.ap-northeast-2.amazonaws.com/amx/S3_AMX10_R2_H1.csv", //csv파일주소
      {
        ...commonConfig,
        header: true,
        download: true,
